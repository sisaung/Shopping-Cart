...
const initialState: ProductState = {
  products: [
    ...
    },
    {
      ...
      price: 999.99,
      description:
        "49 INCH SUPER ULTRAWIDE 32:9 CURVED GAMING MONITOR with dual 27 inch screen side by side QUANTUM DOT (QLED) TECHNOLOGY, HDR support and factory calibration provides stunningly realistic and accurate color and contrast FAST 144Hz refresh rate and hasreycide response time Enjoy smooth, crisp action even in the most demanding games; SWIVEL, TILT, AND HEIGHT ADJUSTABLE; GAMING FEATURES INCLUDE GAME MODES, SCREEN SAVER, AND CUSTOM KEY BINDING Preloaded with PBP/PIP. 1MS input lag, Low input lag mode, and Dual HDMI inputs MULTI-TASKING MADE EASY: with features like Samsung DeX and Picture-by-Picture.",
      category: "electronics",
    ...
    },
    {
      ...
      price: 56.99,
      description:
        "Note:The Jackets is US standard size, Please choose size as your usual wear Material: 100% Polyester; Detachable Liner Fabric: Warm Fleece. The Detachable Liner is made of high-quality, skin-friendly, and wear-resistant fabric. Warm and comfortable. External: Wear-resistant Softshell, the professional water-repellent coating works.",
    ...
    },
    {
      ...
      price: 29.95,
      description:
        "100% POLYURETHANE (shell) 100% POLYESTER (Lining) Faux leather material for style and comfort / 2 pockets of front / 2-For-One Hooded denim style faux leather jacket Regular fit / Lightweight / Fully lined / Available in 2 colors and 4 sizes",
      category: "women's clothing",
    ...
    },
    {
      ...
      price: 39.99,
      description:
        "Lightweight perfet for trip or casual wear---Long sleeve with hooded, adjustable drawstring waist design. Button and zipper front closure raincoat, fully stripe lined and waterproof. Quick-drying when it is raining and easy to pack away in the bag. This Rain Jacket is a light raincoat made for your everyday commute or other outdoor activities, it's easy to put on and take off, and it has a classic shape, making it a solid and practical choice for all seasons.",
      category: "women's clothing",
    ...
    },
    {
      ...
      price: 7.95,
      description:
        "100% Polyester, Machine Wash, Pre Shrunk For A Great Fit Lightweight, roomy, and highly breathable with moisture-wicking fabric which helps to keep moisture away Quick-drying for your comfort Tag-free neck label and generous cut provide a relaxed fit. Perfect for running, workout and training sports and even as an moisture-wicking undershirt.",
      category: "women's clothing",
